...
readonly class UpdateAssessmentDto extends BaseDto
{
    ...
    public function __construct(
        ?string $assessment_name = null, ?string $assessment_category_uuid = null, ?string $assessment_type_uuid = null, ?int $estimated_duration_minutes = null, ?float $total_marks = null, ?float $pass_percentage = null, ?string $description = null
    ) {
