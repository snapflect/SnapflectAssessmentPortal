...
class AssessmentValidationController extends Controller
{
    ...
    public function validate(Request $request, string $assessment_uuid): JsonResponse
    {
        ...
        $result = $this->validationService->validate($assessment_uuid, $organizationId, $userId);
    ...
    public function getReport(Request $request, string $assessment_uuid): JsonResponse
    {
