...
class CreateDepartmentRequest extends FormRequest {
    ...
    public function rules(): array { return [ 'organization_id' => ['required', 'integer'], 'business_unit_id' => ['nullable', 'integer'], 'department_code' => ['required', 'string', 'max:50'], 'department_name' => ['required', 'string', 'max:255'] ]; }
