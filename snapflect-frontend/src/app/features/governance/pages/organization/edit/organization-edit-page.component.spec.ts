...
import { OrganizationEditPageComponent } from './organization-edit-page.component';
...
describe('OrganizationEditPageComponent', () => {
  let component: OrganizationEditPageComponent;
  let fixture: ComponentFixture<OrganizationEditPageComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(OrganizationEditPageComponent);
