        ...
        <div class="overflow-auto flex-1">
          <table class="w-full text-left text-sm text-muted">
            ...
            <tbody [class.opacity-50]="loading" [class.pointer-events-none]="loading" class="transition-opacity duration-300">
              ...
              <ng-container *ngIf="roles | globalSearch: searchTerm as filteredRoles">
                ...
                <tr *ngFor="let role of filteredRoles" class="border-b border-white/5 hover:hover:brightness-110 transition-colors">
                  ...
                  <td class="px-6 py-4">
                    <span class="px-2.5 py-1 text-xs font-medium rounded-full"
                          [ngClass]="role.attributes.status === 'ACTIVE' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'">
