              ...
              <tbody>
                ...
                <tr *ngFor="let c of finalCategories" class="border-b border-white/5 hover:hover:brightness-110 transition-colors">
                  ...
                  <td class="px-6 py-4 text-right space-x-3">
                    <button *ngIf="userStore.hasAnyPermission(['Assessment.Metadata.Manage'])" class="text-muted hover:text-main transition-colors" (click)="openEdit(c)">Edit</button>
                    <button *ngIf="(userStore.hasAnyPermission(['Assessment.Metadata.Manage'])) && userStore.hasAnyPermission(['Assessment.Metadata.Manage'])"  class="text-muted hover:text-red-400 transition-colors" (click)="deleteCategory(c.uuid)">Delete</button>
                  </td>
                </tr>
              </tbody>
            </ng-container>
      ...
      <app-slide-over [isOpen]="isFormOpen"
        ...
        <form [formGroup]="form" (ngSubmit)="submit()" class="space-y-5">
          <div>
            ...
            <input type="text" formControlName="category_code" class="input-field" placeholder="Leave blank to auto-generate">
          </div>
          <div>
