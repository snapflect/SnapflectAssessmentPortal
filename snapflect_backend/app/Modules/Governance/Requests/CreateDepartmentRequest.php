...
class CreateDepartmentRequest extends FormRequest {
    ...
    public function rules(): array { return [ 'organization_id' => ['required', 'integer'], 'business_unit_id' => ['required', 'integer'], 'department_code' => ['nullable', 'string', 'max:50', \Illuminate\Validation\Rule::unique('departments')->whereNull('deleted_date')], 'department_name' => ['required', 'string', 'max:255'] ]; }
