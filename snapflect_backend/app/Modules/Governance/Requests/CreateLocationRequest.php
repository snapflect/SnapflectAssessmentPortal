...
class CreateLocationRequest extends FormRequest {
    ...
    public function rules(): array { return [ 'organization_id' => ['required', 'integer'], 'location_code' => ['nullable', 'string', 'max:50', \Illuminate\Validation\Rule::unique('locations')->whereNull('deleted_date')], 'location_name' => ['required', 'string', 'max:255'], 'address' => ['nullable', 'string'], 'city' => ['nullable', 'string', 'max:100'], 'state' => ['nullable', 'string', 'max:100'], 'country' => ['nullable', 'string', 'max:100'] ]; }
