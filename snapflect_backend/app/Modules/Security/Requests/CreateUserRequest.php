...
class CreateUserRequest extends FormRequest {
    ...
    public function rules(): array { return [ 'organization_id' => ['required', 'integer'], 'business_unit_id' => ['nullable', 'integer'], 'department_id' => ['nullable', 'integer'], 'location_id' => ['nullable', 'integer'], 'first_name' => ['required', 'string', 'max:100'], 'last_name' => ['required', 'string', 'max:100'], 'email' => ['required', 'email', 'max:255', 'unique:users,email'], 'password' => ['required', 'string', 'min:12'] ]; }
