...
Route::get('/manual-reviews/pending', [ManualReviewController::class, 'pendingQueue']);
Route::post('/manual-reviews/{review:uuid}/lock', [ManualReviewController::class, 'lock']);
