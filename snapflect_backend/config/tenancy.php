...
return [
    ...
    /**
     * Map tenant storage keys (from the `data` JSON column) to Laravel config keys.
     * This powers the TenantConfig feature, allowing dynamic SMTP overrides per tenant.
     */
